...
On a séparé les 2 classes, parce qu'on a jugé inutile et dangereux d'utiliser les fonctionalitées d'un tableau lorsque le Smart Pointer n'est pas alloué pour être un tableau. 
